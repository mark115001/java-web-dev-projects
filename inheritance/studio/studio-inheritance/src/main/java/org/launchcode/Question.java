...
public abstract class Question {
    ...
    public Question(String question, Choice[] choiceArray) {
        ...
        createRandomizeChoiceMap(choiceArray);
    ...
    void createRandomizeChoiceMap(Choice[] choiceArray) {
    ...
    String getFormattedChoices() {
        ...
        return formattedChoices.toString();       //using StringBuilder is not a string so must us toString unless concatenating with a string
    }
